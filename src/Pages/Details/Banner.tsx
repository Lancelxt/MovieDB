...
const Discover = ({ video }: DiscoverProps) => {
  ...
  const {
    ...
    loading: crewLoading,
    error: crewError,
  } = useFetch("/" + media_type + "/" + id + "/credits");
  ...
  const director = Array.isArray(crewData?.crew)
    ? crewData?.crew.find((member) => member.job === "Director")
    : null;
  const DirectorName = director ? director.name : null;

  const screenplay = Array.isArray(crewData?.crew)
    ? crewData?.crew.find((member) => member.job === "Screenplay")
    : null;
    ...
    <div className="Banner">
      ...
      <div className="banner-content">
        ...
        <div className="right-wrapper">
          <div className="title2">
            ...
            <div className="facts">
              ...
              <ul className="list">
                ...
                >{`${runtimeInHours}h ${runtimeInMinutes}m`}</li>
              </ul>
            </div>
          </div>
          ...
          <div className="tagline" style={{ color: "#FFF", fontWeight: "400" }}>
            {data?.tagline}
          </div>
