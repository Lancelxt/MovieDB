...
const Social: React.FC<SocialProps> = () => {
        ...
        <div className="review-container">
            <div className="info">
                ...
                <div className="user">
                    ...
                    <div className="author">written by <span style={{fontWeight:400}}>{review?.author}</span> on {formatDate(review?.created_at)}</div>
                    </div>
                </div>
            </div>
  ...
  <p style={{marginLeft:"100px",fontSize:"14.4px",fontWeight:300}}>2</p>
  <div className="dateAndAuthor" style={{marginLeft:"120px"}}>
    <p style={{fontSize:"14.4px",fontWeight:300}}>{formatDate(review?.created_at)}</p>
